 ...
 */
export function binaryOp(token) {
 ...
 * @param {{type: <string>}} ast The subexpression tree
 */
export function subExpression(ast) {
 ...
 * @param {{type: <string>}} ast The subexpression tree
 */
export function ternaryEnd(ast) {
 ...
 * @param {{type: <string>}} ast The subexpression tree
 */
export function ternaryMid(ast) {
 ...
 * @param {{type: <string>}} token A token object
 */
export function transform(token) {
  this._placeBeforeCursor({
    type: 'FunctionCall',
    name: token.value,
    args: [this._cursor],
