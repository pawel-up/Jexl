 ...
 * @private
 */
export function ArrayLiteral(ast) {
 ...
 * @private
 */
export function BinaryExpression(ast) {
 ...
 * @private
 */
export function ConditionalExpression(ast) {
 ...
 * @private
 */
export function FilterExpression(ast) {
 ...
 * @private
 */
export function Identifier(ast) {
  if (!ast.from) {
 ...
 * @private
 */
export function ObjectLiteral(ast) {
 ...
 * @private
 */
export function FunctionCall(ast) {
 ...
 * @constructor
 */
export function UnaryExpression(ast) {
